package com.example.yuye.biz.config;
...
import com.example.yuye.biz.component.DatabaseShardingAlgorithm;
import com.example.yuye.biz.component.TableShardingAlgorithm;
...
public class DataSourceConfig {
    ...
    private DataSource buildDataSource() throws SQLException {
        ...
        dataSourceMap.put(payConfig.getDatabaseName(), payConfig.createDataSource());
        dataSourceMap.put(database0Config.getDatabaseName(), database0Config.createDataSource());
        dataSourceMap.put(database1Config.getDatabaseName(), database1Config.createDataSource());
        //设置默认数据库
        DataSourceRule dataSourceRule = new DataSourceRule(dataSourceMap, payConfig.getDatabaseName());
